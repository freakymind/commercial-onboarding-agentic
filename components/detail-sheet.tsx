...
export function ProcessDetailSheet({
  ...
  const color = isHuman ? palette.human : palette.agentic
      ...
      >
        <SheetHeader className="border-b">
          <div className="flex items-start gap-3">
            ...
            >
              {isHuman ? <User className="size-5" /> : <Cpu className="size-5" />}
            </span>
            <div className="min-w-0 flex-1">
              <div className="mb-1.5 flex flex-wrap items-center gap-1.5">
                ...
                >
                  {isHuman ? "Human / control process" : "Agentic-enhanced process"}
                </Badge>
                {stageName && (
                  <Badge
                    variant="outline"
                    className="text-[10px] font-medium"
                    style={{ borderColor: hexToRgba(palette.primary, 0.3) }}
                  >
                    {stageName}
                  </Badge>
                )}
        ...
        <div className="space-y-6 px-4 py-5">
          {/* Agent blueprint for human processes */}
          {isHuman && process.agentBlueprint && (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm font-semibold leading-tight">
                    How an agent could support or replace this human step
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4 flex items-center justify-between gap-2 rounded-lg border bg-card p-2.5">
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <span>
                    ...
                    —{" "}
                    {maturityDescriptions[process.agentBlueprint.targetMaturity].split(
                      "—",
                    )[0].trim()}
                  </span>
                </div>
